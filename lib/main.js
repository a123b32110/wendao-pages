...
import { indexShared, byPrefix, setShared, delShared, setSharedSoft, sharedRoomFor, PX_BUCKETS, AX_BUCKETS, SX_BUCKETS, AUX_BUCKETS, pxKey, axKey, sxKey, auxKey, utf8Len, BUCKET_BYTES } from "./game/shared.js";
...
// job_key 每次都不一样：固定用 "tick2" 时，onSchedule 在自己那一轮里再加同名任务会被平台吞掉
// （v42 线上实测：ensureTick 加的 tick2 20 秒后准时响，它自己续的 600 秒那次从来不响，
// 于是 bot 实际上是靠玩家请求每 ~20 分钟救一次，而不是每 10 分钟一轮）。一键只用一次就没有这个问题。
